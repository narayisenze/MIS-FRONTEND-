...
const PortfolioReport = () => {
  ...
  return (
    <Card>
      ...
      <CardContent className="px-1 pb-1 md:px-5 md:pb-5">
        <Tabs defaultValue="last-months">
          <TabsList className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-6 justify-start w-full bg-transparent h-full">
