...
const Footer = ({ handleOpenSearch }: { handleOpenSearch: () => void }) => {
  ...
  return (
    <FooterLayout
      className={cn("", {
        "xl:ml-[300px] xl:mr-[300px]": !collapsed,
        "xl:ml-[72px] xl:mr-[72px]": collapsed,
        "sticky bottom-0": footerType === "sticky",
      })}
    >
      <FooterContent />
...
const FooterContent = () => {
  return (
    <div className="block md:flex md:justify-end text-muted-foreground">
      <p className="sm:mb-0 text-xs md:text-sm">
        AMIR {new Date().getFullYear()} All rights Reserved
      </p>
    </div>
  );
};
