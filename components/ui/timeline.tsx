      ...
      <li
        ...
        className={cn(timelineItemVariants({ variant }), className, {
          "[&_.tm-separator]:right-0 [&_.tm-separator]:left-[unset]  [&_.tm-content-wrapper]:text-right [&_.tm-content-wrapper]:pr-8":
            position === "left",
          "[&_.tm-separator]:left-0 [&_.tm-content-wrapper]:pl-8 [&_.tm-separator]:right-0 [&_.tm-separator]:left-[unset]  [&_.tm-content-wrapper]:text-right [&_.tm-content-wrapper]:pr-8":
            position === "right" || position === undefined,
          "w-1/2 ":
            position === "alternate" || position === "alternate-reverse",
          "ml-auto mr-auto   [&_.tm-content-wrapper]:pl-8  [&_.tm-content-wrapper]:pr-8 ":
            (position === "alternate" && even) ||
            (position === "alternate-reverse" && odd),
          "mr-auto [&_.tm-separator]:right-[-17px] [&_.tm-separator]:right-[-8px]  [&_.tm-separator]:left-[unset] [&_.tm-content-wrapper]:text-right [&_.tm-content-wrapper]:pr-4 [&_.tm-content-wrapper]:pl-4":
