  ...
  (
    ...
    >
      ...
      <SwitchPrimitives.Thumb
        className={cn(
          "pointer-events-none z-10 origin-right  h-4 w-4 rounded-full bg-background  shadow-lg ring-0 transition-all  flex items-center justify-center   data-[state=checked]:ml-5 data-[state=checked]:mr-5 data-[state=unchecked]:mr-0.5 ",
          thumbClass,
          {
