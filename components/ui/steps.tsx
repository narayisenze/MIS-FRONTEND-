      ...
      >
        <div
          ...
          className={cn("flex items-center flex-row relative z-[1] ", {
            ...
            "before:left-[44px] before:w-[calc(100%-44px)] before:right-[44px]":
              gap && !alternativeLabel,
            "before:left-1/2 before:right-1/2 ": alternativeLabel && !gap,
            "before:left-[calc(50%+33px)] before:right-[calc(50%+33px)] before:w-[calc(100%-60px)]":
